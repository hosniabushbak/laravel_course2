            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 py-5">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="info-box">
                                <img src="{{asset('assests/img/icon6.png')}}" alt="">
                                <div class="ms-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="info-box">
                                <img src="{{asset('assests/img/icon4.png')}}" alt="">
                                <div class="ms-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="info-box">
                                <img src="{{asset('assests/img/icon5.png')}}" alt="">
                                <div class="ms-4">
                ...
                <div class="col-lg-5">
                    <img src="{{asset('assests/img/about.png')}}" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="text-center">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        <img src="{{asset('assests/img/icon2.png')}}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        <img src="{{asset('assests/img/icon3.png')}}" alt="">
    ...
    <section class="bg-light" id="portfolio">
        ...
        <div id="projects-slider" class="owl-theme owl-carousel">
            <div class="project">
                ...
                <img src="{{asset('assests/img/project1.jpg')}}" alt="">
                <div class="content">
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="{{asset('assests/img/project2.jpg')}}" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="{{asset('assests/img/project3.jpg')}}" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="{{asset('assests/img/project4.jpg')}}" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="{{asset('assests/img/project5.jpg')}}" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{asset('assests/img/team_1.jpg')}}" alt="">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{asset('assests/img/team_2.jpg')}}" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="{{asset('assests/img/team_3.jpg')}}" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
